...
class NewUserOnboardingVerificationVerifyEmail extends DynamicHtmlElement {
   constructor() {
    super();
  }
...
customElements.define("new-user-onboarding-verification-verify-email", NewUserOnboardingVerificationVerifyEmail);
export default NewUserOnboardingVerificationVerifyEmail;
